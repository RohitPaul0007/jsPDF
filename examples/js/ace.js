(function() {
  ...
  define("ace/mouse/fold_handler", ["require", "exports", "module"], function(
    e,
    t,
    n
  ) {
          ...
          if (i == "{") {
            ...
            if (i == "\n" || i == "\r\n") {
              ...
              p.isMaybeInsertedClosing(s, u) &&
                ((m = o.stringRepeat("}", f.maybeInsertedBrackets)),
            ...
            if (i == '"' || i == "'") {
              ...
              if (!u) {
                ...
                var m = d && /string|escape/.test(d.type),
                  ...
                  y;
                if (p == s)
                  (y = m !== g), y && /string\.end/.test(v.type) && (y = !1);
                else {
                  if (m && !g) return null;
                  if (m && g) return null;
        ...
        (this.alignCursors = function() {
          ...
          if (!n.length || s.length == n.length - 1) {
            ...
            (p = this.$reAlignText(p, l)),
              ...
              l ||
                ((o.start.column = 0), (o.end.column = p[p.length - 1].length)),
